...
public class Main1 {
    ...
    public static void main1(String[] args) throws Exception {
        ...
        MenuActionListener test = new MenuActionListener();



        // 设置 "新建" 子菜单被点击的监听器
        newMenuItem.addActionListener(test);
        // 设置 "打开" 子菜单被点击的监听器
        openMenuItem.addActionListener(test);
        // 设置 "退出" 子菜单被点击的监听器
        exitMenuItem.addActionListener(test);
